...
class PredictHelper:
    ...
    def timestamp_for_sample(self, sample_token: str) -> float:
        """
    ...
    def _iterate(self, starting_annotation: Dict[str, Any], seconds: float, direction: str) -> List[Dict[str, Any]]:
        ...
        starting_time = self.timestamp_for_sample(starting_annotation['sample_token'])
        ...
        while time_elapsed <= seconds_with_buffer and len(annotations) < max_annotations:
            ...
            current_time = self.timestamp_for_sample(next_annotation['sample_token'])
    ...
    def get_past_for_ego(self, starting_sample_token, seconds_of_history):
        history = []

        current_sample_token = starting_sample_token
